...
plt.figure()
plt.hist2d(
    azimuth[good_selection_mask][:plot_first],
    zenith[good_selection_mask][:plot_first],
    bins=bin_number,
    cmap="viridis",
)
...
axs[0, 0].hist2d(
    zenith[good_selection_mask][:plot_first],
    zenith_std[good_selection_mask][:plot_first],
    bins=bin_number,
    cmap="viridis",
)
...
axs[1, 0].hist2d(
    zenith[good_selection_mask][:plot_first],
    azimuth_std[good_selection_mask][:plot_first],
    bins=bin_number,
    cmap="viridis",
)
