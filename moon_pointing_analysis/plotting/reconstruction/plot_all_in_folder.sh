...
nohup python ${bash_directory}/reconstruction_both_angles.py -db ${database_directory} --bins ${bins} -o ${output_directory} -p ${pulsemap} > log1.out
nohup python ${bash_directory}/reconstruction.py -db ${database_directory} -o ${output_directory} -p ${pulsemap} > log2.out
