...
database_directory=(\
/groups/icecube/petersen/GraphNetDatabaseRepository/moon_pointing_analysis/trained_models/Leon_MC_model/dynedge_azimuth_Leon_muon_data_MC/results.csv \
/groups/icecube/petersen/GraphNetDatabaseRepository/moon_pointing_analysis/trained_models/Leon_MC_model/dynedge_zenith_Leon_muon_data_MC/results.csv \
)
