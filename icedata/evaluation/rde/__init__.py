...
from .detector import IceCubeDeepCore_RDE
from .dataset import SQLiteDataset_RDE, SQLiteDataset_RDE_Transformed


class Vals_RDE(common.Vals):
    def __init__(self, args: common.Args, *, nb_nearest_neighbours: int = 8):
        self.training_dataloader, self.validation_dataloader, self.test_dataloader = \
            common.get_dataloaders(args, dataset_class=SQLiteDataset_RDE)

        self.detector = IceCubeDeepCore_RDE(
...
class Vals_RDE_Transformed(common.Vals):
    def __init__(self, args: common.Args, *, nb_nearest_neighbours: int = 8):
        self.training_dataloader, self.validation_dataloader, self.test_dataloader = \
            common.get_dataloaders(args, dataset_class=SQLiteDataset_RDE_Transformed)
