...
A4_narrow_width = (11.69+2.82, 8.27)
...
cascade_selection_test = track_cascade_test['event_no'][track_cascade_test['track_mu_pred'] < 0.9]
...
labels = ['All events','p_track > 0.9','p_track < 0.9']#,'LR=1e-02']
...
fig, axs = plt.subplots(1,1,figsize=(11.69+2.82,  8.27))
axs2 = axs.twinx()
...
fig.tight_layout()
plt.tight_layout()
fig.savefig(outdir + 'Zenith_resolution_Morten')
...
fig.savefig(outdir + 'Azimuth_resolution_Morten')
