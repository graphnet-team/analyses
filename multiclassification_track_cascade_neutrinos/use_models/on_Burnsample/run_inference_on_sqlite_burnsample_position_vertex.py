...
from graphnet.training.loss_functions import CrossEntropyLoss,BinaryCrossEntropyLoss, LogCoshLoss, EuclideanDistanceLoss
...
from graphnet.models.task.reconstruction import MulticlassClassificationTask, BinaryClassificationTask, EnergyReconstruction,PositionReconstruction
...
def main(
    ...
    archive = output_path
    run_name = "dynedge_trained_on_Peter_new_muon_{}_predict_40_days_first".format(
        config["target"]
    )
...
if __name__ == "__main__":
    ...
    output_folder = "/groups/icecube/petersen/GraphNetDatabaseRepository/multi_classification_track_cascade_neutrino/using_new_muons_Peter_database/inference/Burnsample"
    model_path = "/groups/icecube/petersen/GraphNetDatabaseRepository/multi_classification_track_cascade_neutrino/using_new_muons_Peter_database/trained_models/osc_next_level3_v2/dynedge_['position_x', 'position_y', 'position_z']_Peter_new_muon_db_SplitInIcePulses_position_test_set/dynedge_['position_x', 'position_y', 'position_z']_Peter_new_muon_db_SplitInIcePulses_position_test_set_state_dict.pth"
