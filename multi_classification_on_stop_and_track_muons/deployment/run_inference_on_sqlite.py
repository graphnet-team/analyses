...
def main(
    ...
    archive = output_path
    run_name = "dynedge_trained_on_leon_RD_{}_predict_first".format(
        config["target"]
    )
    ...
    results.to_csv(
        output_folder + "/{}_Leon_RD_results_first.csv".format(config["target"])
    )
...
if __name__ == "__main__":
    ...
    input_db = "/groups/icecube/leonbozi/work2/data_real/lvl3_dbs_real/last_one_lvl3/data/last_one_lvl3.db"
    output_folder = "/groups/icecube/petersen/GraphNetDatabaseRepository/multi_classification_stop_track_muon/Inference"
    model_path = "/groups/icecube/peter/storage/Multiclassification/Real/last_one_lvl3MC/dynedge_pid_Real_run_21.5_mill_equal_frac_/dynedge_pid_Real_run_21.5_mill_equal_frac__state_dict_first.pth"
