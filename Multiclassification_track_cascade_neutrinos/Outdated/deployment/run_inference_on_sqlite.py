...
def main(
    ...
    archive = output_path
    run_name = "dynedge_trained_Peter_&_Morten_{}_predict_40_days_first".format(
        config["target"]
    )
    ...
    results.to_csv(
        output_folder + "/{}_Morten_&_Peter_Burnsample_RD_and_MC_Full_db.csv".format(config["target"])
    )
...
if __name__ == "__main__":
    ...
    model_path = "/groups/icecube/petersen/GraphNetDatabaseRepository/multi_classification_stop_track_muon/trained_models/osc_next_level3_v2.00_genie_muongun_noise_120000_140000_160000_130000_888003_track/dynedge_pid_classification3_state_dict.pth"
